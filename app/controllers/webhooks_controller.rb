class WebhooksController < ApplicationController
  ...
  def handle_payment_succeeded(payment_intent)
    ...
    Rails.logger.info("Payment succeeded for user #{user.id} with amount #{payment.amount}")
  rescue StandardError => e
  ...
  def handle_payment_failed(payment_intent)
    ...
    Rails.logger.info("Payment failed for user #{user.id} with amount #{payment.amount}")
  rescue StandardError => e
